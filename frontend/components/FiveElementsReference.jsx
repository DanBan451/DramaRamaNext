...
/**
 * Shared 5 Elements reference UI. `/framework` and `/the-practice` use the same
 * grid and deep-dive; hero copy and attribution placement differ by variant.
 */
export default function FiveElementsReference({ variant = "framework" }) {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-24 px-6 pt-32">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="font-display text-5xl md:text-6xl text-black mb-6">
            {isPractice ? "The Practice" : "The 5 Elements of Effective Thinking"}
          </h1>
          <p className="text-xl text-smoke max-w-2xl mx-auto leading-relaxed">
            {isPractice ? (
              <>
                The five elements you train in the Forge. Based on the work of Edward B.
                Burger.
              </>
            ) : (
              <>
                Five ways of thinking that turn problems into puzzles. From Edward B.
                Burger&apos;s framework. Come back to this page often — these are the
          ...
          {!isPractice && (
            <p className="text-smoke text-sm mb-8 mt-6">
              Based on the work of Edward B. Burger — <em>The 5 Elements of Effective Thinking</em>{" "}
              and <em>Making Up Your Own Mind</em>. With deep gratitude.
            </p>
          )}
        </div>
      </section>
            ...
            <div className="flex gap-6 items-start">
              ...
              <div>
                <h3 className="text-lg font-semibold text-black mb-2">
                  We build a goal around the muscles you need
                </h3>
              </div>
            </div>
      ...
      <section className="py-24 px-6 bg-black text-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-smoke mb-10">
            Tell us what you want to be more effective at. We&apos;ll build your goal.
          </p>
      ...
      {isPractice && (
        <section className="py-12 px-6 bg-mist">
          <div className="max-w-3xl mx-auto text-center">
            <p className="text-smoke text-base leading-relaxed">
              Based on Edward B. Burger — <em>The 5 Elements of Effective Thinking</em>{" "}
              and <em>Making Up Your Own Mind</em>. With deep gratitude.
            </p>
          </div>
        </section>
